...
# check if complications are present in the abstracts
    ...
    for AE in complications_db['complications'][complication]:
        ...
        for syn in complications_db['complications'][complication][AE]:
            ...
            try:
                ...
                complications_matrix[AE] = pubmed_raw_data.abstract.str.count(
...
complication_matrix_plot['main_cat'] = complication_matrix_plot['index'].map(
    body_map)
